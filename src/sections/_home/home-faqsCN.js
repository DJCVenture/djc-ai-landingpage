...
const CONTENTS = [
  ...
  },
  {
    ...
    answer: `注册后，您将收到邀请加入我们的委员会群组，在那里您可以通过群聊随时与我们互动。`,
  },
  {
    question: '为什么 DJC AI 需要连接我的 Google 账号？',
    answer: `DJC AI 与 Google 服务集成，为您提供安全便捷的 Google 一键登录以及 Google 日历同步功能。通过日历权限，AI 智能助手能够实时查看您的空闲日程，并在与潜在客户沟通时自动安排并写入预约，无需手动往复确认。`,
  },
  {
    question: 'DJC AI 如何保护我的 Google 用户数据与隐私？',
    answer: `我们严格遵守 Google API 服务用户数据政策（包括限制使用要求）。您的 Google 账号和日历数据仅用于提供身份认证和预约同步功能，我们绝不会出售您的个人数据，也绝不会将其分享给任何第三方或广告商。`,
  },
  {
    question: '数据/内容/订阅者的所有权归谁？',
    answer: `归您所有！任何内容（包括您的用户）都是100%属于您的。DJC系统无权使用那些内容或出于任何原因联系您的用户。`,
  },
  {
    question: '我如何开始使用？',
